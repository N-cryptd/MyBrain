...
object Constants {
    ...
    // lINKS
    const val PROJECT_GITHUB_LINK = "https://github.com/N-cryptd/MyBrain"
    const val PROJECT_ROADMAP_LINK = "https://github.com/users/N-cryptd/projects/2"
    const val PRIVACY_POLICY_LINK = "https://github.com/N-cryptd/MyBrain/blob/master/privacy-policy.md"
    const val GITHUB_ISSUES_LINK = "https://github.com/N-cryptd/MyBrain/issues"
    const val GITHUB_RELEASES_LINK = "https://github.com/N-cryptd/MyBrain/releases"
}